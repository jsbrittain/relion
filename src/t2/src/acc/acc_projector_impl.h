...
// //============================ save to file ============================
// 	// std::string path = "/home/fujy/relion/test/test_coarse/data/trpv1/projector";
// 	std::string path = "/home/xujingle/tensor_core/data/trpv1/projector";
...
// 	std::string base_filename = "projector_proc_" + std::to_string(rank);
// 	std::string filename = path + "/" + base_filename + "_1.dat";
	
// 	// If file exists, change filename to filename.1, filename.2, etc.
// 	int i = 2;
// 	while (std::ifstream(filename))
// 	{
// 		filename = path + "/" + base_filename + "_" + std::to_string(i) + ".dat";
// 		i++;
// 	}
