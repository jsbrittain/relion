...
class AccProjectorPlanNew: public AccProjectorPlan
{
public:
	AccPtrNew< long unsigned> iorientclasses;
	AccPtrNew<XFLOAT> eulers;
	AccProjectorPlanNew():
		AccProjectorPlan()
    {};
	
	// AccProjectorPlanNew(CudaAllocatorTask *allocator_task):
	// 	iorientclasses(allocator_task),
	// 	eulers(allocator_task)
	// {};

	AccProjectorPlanNew(StreamType s,CudaAllocatorTask *allocator_task,
						CudaCustomAllocator *allocator):
		iorientclasses(s,allocator_task,allocator),
		eulers(s,allocator_task,allocator)
	{};
	...
	void set_up_from_old_plan(AccProjectorPlan &old_plan);
};
