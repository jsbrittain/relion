...
// class CudaFFTNew:public CudaFFT
// {
// public:
// #ifdef ACC_DOUBLE_PRECISION
// 	AccPtrNew<cufftDoubleReal> reals;
// 	AccPtrNew<cufftDoubleComplex> fouriers;
// #else
// 	AccPtrNew<cufftReal> reals;
// 	AccPtrNew<cufftComplex> fouriers;
// #endif
// 	CudaAllocatorTask *CFallocator;


// 	CudaFFTNew(cudaStream_t stream, int transformDimension = 2):
// 		CudaFFT(stream, NULL, transformDimension),
// 		reals(stream, NULL),
// 		fouriers(stream, NULL)
// 	{};

// 	void setAllocator(CudaAllocatorTask *allocator)
// 	{
// 		reals.setAllocatorTask(allocator);
// 		fouriers.setAllocatorTask(allocator);
// 		CFallocator = allocator;
// 	}
...
// 		if (x == xSize && y == ySize && z == zSize && batch == reqN && this->planSet)
// 			return;
